...
export default function SkillTable({ skills = [] }) {
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-[#cdeee4]/70 bg-white shadow-sm">
      <div className="border-b border-[#cdeee4] p-5">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-[#cdeee4] text-sm">
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {skills.map((skill) => (
              <tr key={skill.id} className="hover:bg-[#f8fffb]">
                ...
                <td className="px-5 py-4 text-right">
                  <Link
                    ...
                    className="inline-flex rounded-xl border border-[#cdeee4] px-3 py-2 text-sm font-medium text-[#114444] transition hover:bg-[#e8fff4]"
                  >
                    View Jobs
                  </Link>
                </td>
